...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: "11/08/2026",
    highlights: [
      "Correção do arquivo SPA antigo que ainda era detectado na publicação web.",
      "Limpeza definitiva do cache HTML legado para impedir a tela branca.",
    ],
  },
  {
    version: "1.0.1",
    date: "11/08/2026",
    highlights: [
      "Correção definitiva da tela branca no site publicado.",
      "Build do site e pacote Android agora são gerados separadamente.",
    ],
  },
  {
