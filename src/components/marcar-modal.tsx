...
const fieldClass =
  "w-full rounded-[12px] border-2 bg-white px-3 py-3 text-[15px] font-semibold outline-none transition focus:ring-2";
const fieldStyle = { borderColor: "#1B3A6B", color: "#1A1A2E" } as const;
      ...
      <DialogContent className="max-w-[420px] gap-0 rounded-[20px] p-0">
        ...
        <div className="max-h-[70vh] space-y-4 overflow-y-auto px-5 py-4">
          ...
          <div>
            ...
            >
              <SelectTrigger
                className="h-[52px] w-full rounded-[12px] border-2 bg-white px-3 text-[15px] font-semibold"
                style={fieldStyle}
              >
        ...
        {/* Footer */}
        <div className="flex gap-2 border-t border-[#E8EEF4] px-5 py-4">
          <button
            onClick={() => onOpenChange(false)}
            className="h-[48px] flex-1 rounded-[14px] border-2 bg-white font-bold active:scale-[0.99]"
