...
export const ARTIGOS: Artigo[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { h: "Comece pelo sono" },
      "Sono fragmentado derruba concentração e humor. Duas noites mal dormidas costumam comprometer a semana seguinte.",
      { h: "Bloqueie tempo" },
      ...
      "Calendário, lembretes automáticos e backup poupam energia mental — configure uma vez e esqueça.",
    ],
    related: ["planejamento-plantao"],
  },
  {
