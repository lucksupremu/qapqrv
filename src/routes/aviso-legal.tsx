...
export const Route = createFileRoute("/aviso-legal")({
  head: () => ({
    meta: [
      { title: "Aviso Legal — QAP, QRV!" },
      { name: "description", content: "Aviso legal do QAP, QRV!: natureza independente, limitações de responsabilidade e canais oficiais da PMESP." },
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="mx-auto max-w-3xl px-5 py-5 space-y-4 text-[15px] leading-relaxed text-foreground/85">
        <p>
          O <strong>QAP, QRV!</strong> é um aplicativo independente, mantido de
        ...
        <p>
          ...
          oficiais da Corporação. O QAP, QRV! não substitui a intranet PMESP,
